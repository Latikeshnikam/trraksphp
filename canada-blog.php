...
<div class="container mb-4" >
  <div class="row" style="height: 300px;background-image: url(img/study_canada.png); background-size: cover;margin-right: 0.0rem;margin-left: 0.0rem;">
    <!-- <img src="img/study_australia.png" alt="" width="100%"> -->
    <!-- <div class="col-md-8"></div> -->
    <div class="header col-md-4  ml-auto">
      <h1><b>Study in CANADA </b></h1>
    </div>

    ...
    { 
      ...
      $select_registered = $conn->query($select_registered); 
       if($select_registered->num_rows > 0)
       {
        ...
        {
          $insert_user="INSERT INTO `register_user` (`USER_NAME`,`Full_Name`,`Mo_No`,`Email`,  `Current_Location`, `Password`) VALUES ('$USER_NAME','$STUDENT_NAME','$STUDENT_MOBILE','$STUDENT_EMAIL','$CURRENT_CITY','$USER_PASSWORD')";
                     ...
                     require PATH.'/vendor/autoload.php';
                      ...
                      try {
                         ...
                         // $mail->SMTPDebug = 1;                                 // Enable verbose debug output
                          ...
                          $mail->addAddress($STUDENT_EMAIL,$USER_NAME);     // Add a recipient

                          $mail->isHTML(true);                                  // Set email format to HTML
                          $mail->Subject = "Your account has been verified ".$USER_NAME;
                          ...
                          $mail->Body    = "<body style='background-color: #e6e6e6'>
                                        <div class='container' style='background-color: white; width:600px; height: 400px; border:0.5px solid white; margin-left:20%;margin-top:2%; padding:3%;'> 
                                         ...
                                         <span style='display:inline-block; width: 15px;'></span><span style='font-size: 18px;'><i style='color:green'>Your account has been verified.</i><br><span style='display:inline-block; width: 15px;'></span><span style='font-size: 18px;'>Now you are able to access our system and you can evaluate you profile right away. Trraks Education Platform will also help you out through out the admission process.</span><br> 
                          ...
                          // echo 'Message has been sent';
                             ...
                             $delete=mysqli_query($conn,"DELETE FROM `otp_data` WHERE `MOBILENO`='$STUDENT_MOBILE'");
